    ...
    <div className="container mx-auto px-4">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8">
        <div className="text-center">
          <div className="text-xl sm:text-3xl md:text-4xl font-bold text-white mb-0 sm:mb-1">$0</div>
          <div className="text-white/70 text-xs sm:text-sm">Call-Out Fee</div>
        </div>
        <div className="text-center">
          <div className="text-xl sm:text-3xl md:text-4xl font-bold text-white mb-0 sm:mb-1">100%</div>
          <div className="text-white/70 text-xs sm:text-sm">Price Transparency</div>
        </div>
        <div className="text-center">
          <div className="text-xl sm:text-3xl md:text-4xl font-bold text-white mb-0 sm:mb-1">10%</div>
          <div className="text-white/70 text-xs sm:text-sm">Senior Discount</div>
        </div>
        <div className="text-center">
          <div className="text-xl sm:text-3xl md:text-4xl font-bold text-white mb-0 sm:mb-1">Best</div>
          <div className="text-white/70 text-xs sm:text-sm">Price Guarantee</div>
        </div>
      </div>
    </div>
  </div>
